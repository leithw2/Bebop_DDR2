...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/laptop/catkin_ws/src/rotors_simulator/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/laptop/catkin_ws/devel/.private/rotors_gazebo_plugins)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/laptop/catkin_ws/install)
...
if(NOT "/home/laptop/catkin_ws/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/local/include/eigen3 " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/laptop/catkin_ws/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/local/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/laptop/catkin_ws/src/rotors_simulator/rotors_gazebo_plugins/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rotors_gazebo_plugins_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rotors_gazebo_motor_model;rotors_gazebo_controller_interface")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/laptop/catkin_ws/devel/.private/rotors_gazebo_plugins/lib;/home/laptop/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
set(depends "cv_bridge;geometry_msgs;mav_msgs;octomap_msgs;octomap_ros;rosbag;roscpp;rotors_comm;rotors_control;std_srvs;tf;gazebo_dev")
