...
from geometry_msgs.msg import Transform, Quaternion, Point, Twist, Pose, PoseStamped, PoseWithCovarianceStamped
...
class controller():
    ...
    def move(self, target):
        ...
        if self.moveState == 2 and dist < 0.10:
            self.moveState = 0
            #self.stateMachine = 0 #stand by
            return
